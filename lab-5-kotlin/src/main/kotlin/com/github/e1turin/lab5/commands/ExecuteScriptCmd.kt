...
class ExecuteScriptCmd(
    ...
    override fun exec(arg: String, target: MusicBandStorage, ioStream: IOStream): Message {
        ...
        var pathToScriptFile: String = ioStream.termInputUntil(
            sep = "path =",
        ...
        return Request(cmdName, RequestType.DO_TASK, StorageManager.TaskType.EXEC_SCRIPT,
